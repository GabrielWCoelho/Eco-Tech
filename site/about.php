...
<div class="titulo-sobre-nós">
    <h1>SOBRE NÓS</h1>
</div>

<h2 class="texto-sobre-nós">
    
    A Eco-Tech é uma empresa com compromisso com o meio<br>
    ambiente e interesse na busca de construir valor para a<br>
    sociedade, Com uma proposta real de reduzir o impacto<br>
    ambiental, Contaminações e impactos sociais.<br>
